  ...
  return (
    <div className="px-4 pt-10 md:px-10 flex-1">
      <Title
        ...
        subtitle="Monitor overall platform performance including total cars and bookings"
      />

      {/* Dashboard Cards */}
      <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 my-8 max-w-5xl">
        {dashboardCards.map((card, index) => (
          <div key={index} className="flex gap-2 items-center justify-between p-4 border rounded-md shadow-sm">
            <div>
